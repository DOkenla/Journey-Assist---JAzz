package com.ygaps.jazz.view.stoppoint
...
import com.ygaps.jazz.network.model.ApiServiceAddStopPointToJourney
import com.ygaps.jazz.network.model.ApiServiceGetNotificationOnRoad
import com.ygaps.jazz.network.model.ApiServiceUpdateStopPoint
...
class StopPointEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var mCityId = intent.extras!!.getInt("cityId")
        ...
        saveStopPointInfo.setOnClickListener {
            ...
            val cityId = spinnerStopPointCity.selectedIndex+1

            Log.d("abab", timeArrive.toString() + " - " + timeLeave.toString())
            ApiRequestUpdateStopPoint(mJourneyId, name, currentPointLatLng, timeArrive, timeLeave,type,min,max,cityId)
        }
...
//        spinnerStopPointIndex.selectedIndex = mIndex
        ...
        spinnerStopPointCity.setItems(Constant.cityList)
        spinnerStopPointCity.selectedIndex = mCityId
    ...
    fun ApiRequestUpdateStopPoint(journeyId : Int, name : String, pos :LatLng, arri : Long, leav : Long, type : Int, min : Long, max : Long, cityId : Int) {
        doAsync {
            ...
            mainbody.addProperty("journeyId", journeyId)
