...
class CreateJourneyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        floatgetcoordinate.setOnClickListener {
            if (editJourneyName.text.toString().isEmpty()) {
                editJourneyName.error = "Required*"
            ...
            else if (editMinCostJourney.text.isNullOrEmpty()) {
                editMinCostJourney.error = "Required*"
            }
            else if (editMaxCostJourney.text.isNullOrEmpty()) {
                editMaxCostJourney.error = "Required*"
            }
            else {
                val intent = Intent(this, GetCoordinateActivity::class.java)
                intent.putExtra("iJourneyName", editJourneyName.text.toString())
                ...
                intent.putExtra("iMinCost", editMinCostJourney.text.toString().toLong())
                intent.putExtra("iMaxCost", editMaxCostJourney.text.toString().toLong())
