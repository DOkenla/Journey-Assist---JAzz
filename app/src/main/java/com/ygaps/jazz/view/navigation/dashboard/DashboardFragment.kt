package com.ygaps.jazz.view.navigation.dashboard
...
import com.ygaps.jazz.ResponseUserNotification
import com.ygaps.jazz.JourneyNotification
import com.ygaps.jazz.manager.doAsync
import com.ygaps.jazz.network.model.ApiServiceGetNotifications
...
class DashboardFragment : Fragment() {
    ...
    var listNotification = ArrayList<JourneyNotification>()
    var token : String = ""
    ...
    inner class NotificationAdapter(data: ArrayList<JourneyNotification>) :
        RecyclerView.Adapter<NotificationAdapter.RecyclerViewHolder>() {

        var data = ArrayList<JourneyNotification>()
        ...
        override fun onBindViewHolder(holder: RecyclerViewHolder, position: Int) {
            ...
            holder.content.text = Html.fromHtml("<b>${item.hostName}</b> has invited you to join journey <b>${item.name}</b>")
            ...
            call.enqueue(object : Callback<ResponseUserNotification> {
                ...
                override fun onResponse(
                    ...
                    if (response.code() != 200) {
                        ...
                        listNotification.addAll(response.body()!!.journeys)
    ...
    fun ApiRequestResponseInvitation(root : View, journeyId: Int, isAccept: Boolean) {
