    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnFloatFinish.setOnClickListener {
            if (checkNoStartEndPoint()) {
                ...
                jsonObject.addProperty("name", extras.getString("iJourneyName"))
                ...
                val service = WebAccess.retrofit.create(ApiServiceCreateJourney::class.java)

                val call = service.postData(logintoken, jsonObject)

                call.enqueue(object : Callback<ResponseCreateJourney> {
                    override fun onFailure(call: Call<ResponseCreateJourney>, t: Throwable) {
                        Toast.makeText(applicationContext, t.message, Toast.LENGTH_LONG).show()
                    }

                    override fun onResponse(
                        call: Call<ResponseCreateJourney>,
                        response: Response<ResponseCreateJourney>
                    ) {
                        if (response.code() == 200) {
                            Log.d("resres", "Add journey")
                            ...
                            val newJourneyId = response.body()!!.id
                            deleteStartEndPoint(mStopPointArrayList)
                            val stpJsonObj = JsonObject()
                            stpJsonObj.addProperty("journeyId", response.body()!!.id.toString())
                            ...
                            val servicestp =
                                WebAccess.retrofit.create(ApiServiceAddStopPointToJourney::class.java)
                            ...
                            callstp.enqueue(object : Callback<ResponseAddStopPoint> {
                                ...
                                override fun onResponse(
                                    ...
                                    if (response.code() == 200) {
                                        ...
                                        val intent = Intent(
                                            applicationContext,
                                            JourneyInfoActivity::class.java
                                        )
                                        intent.putExtra("token", token)
                                        intent.putExtra("journeyID", newJourneyId)
                    ...
                    popupSuggestPointInfo(serviceId.toInt())
                     ...
                     view.editSuggestBtn.setOnClickListener {
                         ...
                         var latlng = LatLng(item.lat!!, item.long!!)
                             ...
                             popup.spinnerCity.selectedIndex = item.cityId!!
...
//        }
    ...
    inner class stopPointAdapter : BaseAdapter {
        ...
        var listJourneyArr = ArrayList<stopPoint>()
        var context: Context? = null

        constructor(listJourneyArr: ArrayList<stopPoint>, context: Context) : super() {
            this.listJourneyArr = listJourneyArr
        ...
        override fun getItem(position: Int): Any {
            return listJourneyArr[position]
        }
    ...
    fun popupSuggestPointInfo(pos : Int) {
        ...
        view.addSuggestToJourney.setOnClickListener {
    ...
    fun inflateAddStopPointView() : View {
        ...
        val spinnercity = view.findViewById<MaterialSpinner>(R.id.spinnerCity)
    ...
    fun saveStopPointToList(view : View, latlng : LatLng, popupWindow: PopupWindow, id : Int? = -1, oldIndex : Int = -1) {
        ...
        if (namefield.text.isNullOrEmpty()) {
            ...
            val city =
                view.findViewById<MaterialSpinner>(R.id.spinnerCity).text.toString()
            stoppint.cityId = util.getCityID(city)
